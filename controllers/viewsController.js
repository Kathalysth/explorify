...
exports.alerts = (req, res, next) => {
  ...
  if (alert === 'booking') {
    res.locals.alert = "Your booking was successful! Please check your email for a confirmation. If your booking doesn't show up immediatly, please come back later"
  }
  next()
}
